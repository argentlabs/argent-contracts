...
const MODULES_TO_ENABLE = ["DsrManager"];
...
const deploy = async (network) => {
    ...
    const DsrManagerWrapper = await deployer.deploy(
        DsrManager,
        {},
    ...
    newModuleWrappers.push(DsrManagerWrapper);
    ...
    configurator.updateModuleAddresses({
        DsrManager: DsrManagerWrapper.contractAddress
    });
    ...
    await Promise.all([
        abiUploader.upload(DsrManagerWrapper, "modules")
    ]);
