...
contract UniZap {
    ...
    function _swapExactTokensAndAddLiquidity(
        ...
        uint swapInAmount;
        {
            (uint reserveIn,) = UniswapV2LibraryMock.getReserves(address(factory), tokenIn, otherToken);
    ...
    function _removeLiquidityAndSwap(
        ...
        address pair = UniswapV2LibraryMock.pairFor(address(factory), undesiredToken, desiredToken);
