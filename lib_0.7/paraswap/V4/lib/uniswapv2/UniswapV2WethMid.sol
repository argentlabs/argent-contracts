...
contract UniswapV2WethMid is IExchange {
    ...
    */
    ...
    function getKey() public override pure returns(bytes32) {
        return keccak256(abi.encodePacked("UNISWAPV2WETHMID", "1.0.0"));
    }
        ...
        returns (uint256)
    {
        ...
        //Since this method is called hence I am assuming fromToken or toToken cannot be ETH
